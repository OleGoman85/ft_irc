                       ...
                       const std::string&              command)
{
    ...
    if (isFirstUser) {
        ...
        std::string opMsg = ":" + server->_clients[fd]->nickname + " MODE " + channelName + " +o " + server->_clients[fd]->nickname + "\r\n";
    ...
    if (!it->second.getTopic().empty()) {
        std::string topicMsg = "332 " + server->_clients[fd]->nickname + " " + channelName + " :" + it->second.getTopic() + "\r\n";
