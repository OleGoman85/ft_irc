...
/*   Updated: 2025/02/04 11:53:06 by ogoman           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * Sets default values for the channel topic, invite-only and topic-restricted modes,
 * channel key and user limit. Also initializes the mode flags in the _modes map.
 *
 ...
 *
 * Iterates over the _clients vector and removes the client with the given file descriptor.
 *
 ...
 *
 * Iterates over the _clients vector to verify if a client with the given file descriptor is a member.
 *
 ...
 *
 * Updates the mode flag for the specified mode character and, if necessary, sets a parameter.
 * Supported modes:
 * - 'i': Invite-only mode.
 ...
 * - 'o': Operator mode is not handled here as operator management is done via separate methods.
 *
 ...
 *
 * @return A constant reference to the vector containing file descriptors of channel members.
 */
 ...
 *
 * If the specified client is not already an operator, adds its file descriptor to the _operators vector.
 *
 ...
 *
 * Searches for the client's file descriptor in the _operators vector and removes it.
 *
 * @param fd The file descriptor of the client whose operator status should be removed.
 */
 ...
 *
 * Iterates over the _operators vector to determine if the given file descriptor corresponds to an operator.
 *
 * @param fd The file descriptor of the client.
